%% -*- coding: utf-8 -*-
%% Time-stamp: <Chen Wang: 2025-12-10 21:12:07>
...
\usepackage[totoc=false,font=small,rule=0.2pt]{idxlayout}
...
% \input{contents/028_ChuMian}
% \input{contents/029_JianSe}
% \input{contents/030_TaiChi}
% \input{contents/031_FenJuan}
% \input{contents/032_ChanXian}
% \input{contents/033_YouHui}
% \input{contents/034_PiLou}
\input{contents/035_HuoNi}
\input{contents/036_ChouXi}
